...
> 本项目原名 Video-shipcut，v1.1.0 起按公司平台项目代号统一更名为 **P0-C**，编排入口 Skill 为 `p0-c-pipeline`。当前版本 **v1.4.0（字幕专员版本）**：subtitle-expert 全量剥出立册并彻底化（第二个可迁移插件专员，002 问题⑧㉖㊍出生证），"底座+插件"架构定案，同批收口 002 验收问题清单 14 条测后裁决（含⑧渲染器能力档根治）。上一里程碑 v1.3.0（BGM 完善版本）：music-expert 六节点接线、找乐通道路由定案、G0–G5 全链验收录制闭环。
