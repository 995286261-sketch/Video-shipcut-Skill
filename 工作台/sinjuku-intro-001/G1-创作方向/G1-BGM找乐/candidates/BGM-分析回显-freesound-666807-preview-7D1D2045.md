# BGM 分析回显 — freesound-666807-preview.mp3

- 做了什么：ffmpeg 全量解码核验 → librosa 节奏/起音/能量分析 → ebur128 响度实测（版本 music-expert-analysis-v0.2）；同文件重跑命中缓存不重算
- 全局事实：0:03.245 ｜ 152.0 BPM（拍间隔中位 418ms）｜ 卡点 11（4 离拍重音 + 7 拍点） ｜ 积分响度 -11.0 LUFS
...
- 分析报告：`工作台/sinjuku-intro-001/G1-创作方向/G1-BGM找乐/candidates/BGM-分析报告-freesound-666807-preview-7D1D2045.json`
