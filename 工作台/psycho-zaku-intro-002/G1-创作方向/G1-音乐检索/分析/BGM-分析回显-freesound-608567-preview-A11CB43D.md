# BGM 分析回显 — freesound-608567-preview.mp3

- 做了什么：ffmpeg 全量解码核验 → librosa 节奏/起音/能量分析 → ebur128 响度实测（版本 music-expert-analysis-v0.2）；同文件重跑命中缓存不重算
- 全局事实：0:04.264 ｜ 89.1 BPM（拍间隔中位 0ms）｜ 卡点 7（6 离拍重音 + 1 拍点） ｜ 积分响度 -15.1 LUFS
...
- 分析报告：`工作台/psycho-zaku-intro-002/G1-创作方向/G1-音乐检索/分析/BGM-分析报告-freesound-608567-preview-A11CB43D.json`
